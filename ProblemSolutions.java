...
class ProblemSolutions {
    ...
    public boolean canFinish(int numExams,
                             int[][] prerequisites) {  // ADD YOUR CODE HERE
    ...
    public int numGroups(int[][] adjMatrix) { // YOUR CODE GOES HERE
    ...
    private void dfsUtil (int matrix, boolean[] visited, Map<Integer, List<Integer>> graph) {
        visited[matrix] = true;

        List<Integer> group = graph.get(matrix);
        if (group == null) {
            return;
        }
